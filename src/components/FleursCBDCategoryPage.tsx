...
const FleursCBDCategoryPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black relative overflow-hidden">
      ...
      {/* Categories Section */}
      <section className="relative z-20 py-20 bg-gradient-to-br from-gray-900/50 to-black/70" aria-labelledby="categories-heading">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-base sm:text-lg text-gray-300 max-w-3xl mx-auto">
              Découvrez notre sélection premium de produits CBD soigneusement choisis pour votre bien-être
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[
              {
                name: "Fleurs CBD Premium",
                description: "Fleurs de qualité supérieure cultivées avec soin",
                image: "https://cbdpascher13.fr/wp-content/uploads/2025/03/fleurs.png"
              },
              {
                name: "Résines & Hash",
                description: "Concentrés puissants aux arômes authentiques",
                image: "https://cbdpascher13.fr/wp-content/uploads/2025/02/Design-sans-titre-4.png"
              },
              {
                name: "Packs Découverte",
                description: "Sélections variées pour tous les goûts",
                image: "https://cbdpascher13.fr/wp-content/uploads/2025/02/Design-sans-titre-5.png"
              }
            ].map((category, index) => (
              <article
                key={index}
                className="group relative bg-white/10 backdrop-blur-sm rounded-2xl overflow-hidden border border-white/20 hover:border-[#08F06C]/50 transition-all duration-500 transform hover:-translate-y-4 hover:shadow-2xl hover:shadow-[#08F06C]/25 cursor-pointer"
                tabIndex={0}
